...
const ROUTES = {
  ...
  'docs/mcp': ['/docs/mcp.md', 'the MCP documentation'],
  'state-of-compliance': ['/state-of-compliance.md', 'the state of compliance report'],
  'changelog': ['/changelog.md', 'the changelog'],
  'work/compile': ['/work/compile.md', 'the compile case study'],
  'work/continuity': ['/work/continuity.md', 'the continuity case study'],
  'specs': ['/specs.md', 'the specs page'],
  ...
  'continuity': ['/continuity.md', 'the continuity page'],
  'frameworks': ['/frameworks.md', 'the frameworks index'],
  'work': ['/work.md', 'the work index'],
  'learn': ['/learn.md', 'the learn index'],
  'acoustic-tokens': ['/acoustic-tokens.md', 'the acoustic tokens page'],
  'badge': ['/badge.md', 'the badge page'],
  'kits/design-review': ['/kits/design-review.md', 'the design review kit'],
  'm3-bridge': ['/m3-bridge.md', 'the M3 bridge page'],
  'open/handoff': ['/open/handoff.md', 'the open handoff'],
  'privacy': ['/privacy.md', 'the privacy page'],
  'review/acoustics': ['/review/acoustics.md', 'the acoustics review'],
  'review/cadence': ['/review/cadence.md', 'the cadence review'],
  'review/designesy-org': ['/review/designesy-org.md', 'the designesy.org review'],
  'review/keyboard': ['/review/keyboard.md', 'the keyboard review'],
  'review/poise': ['/review/poise.md', 'the poise review'],
  'review/poise/keyboard': ['/review/poise/keyboard.md', 'the poise keyboard review'],
  'review/takt': ['/review/takt.md', 'the takt review'],
  'score/bolt': ['/score/bolt.md', 'the bolt score'],
  'score/lovable': ['/score/lovable.md', 'the lovable score'],
  'score/v0': ['/score/v0.md', 'the v0 score'],
  'spring-validator': ['/spring-validator.md', 'the spring validator'],
  'work/designesy-org': ['/work/designesy-org.md', 'the designesy.org case study'],
  'work/lovable-dev': ['/work/lovable-dev.md', 'the lovable.dev case study'],
  'work/tile': ['/work/tile.md', 'the tile case study'],
};
