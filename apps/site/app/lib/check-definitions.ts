...
const CHECK_DEFINITIONS: Omit<CheckDefinition, 'weight'>[] = [
  ...
  { id: 'v06', item: 'Contrast remains readable for ink, muted, and accent on paper (WCAG 2.1 + APCA)', category: 'accessibility', type: 'auto', threshold: 'WCAG AA 4.5:1 (body), 3:1 (large text); APCA Lc 75 body min, Lc 90 body preferred, Lc 60 non-body content', pass: 'all tokens ≥ 4.5:1 against --paper', fail: 'any token below 3:1', warn: 'token below 4.5:1 but above 3:1', ceiling: 65 },
  ...
  { id: 'v24', item: 'Touch targets ≥44px on interactive elements (WCAG 2.5.5 Enhanced)', category: 'accessibility', type: 'auto', threshold: '44px minimum on interactive elements (SC 2.5.5 Target Size Enhanced, AAA; 2.5.8 Minimum AA is 24px — engine enforces the stricter 44px bar)', pass: 'touch targets ≥ 44px', fail: 'touch targets below 44px', warn: 'n/a', ceiling: 75 },
