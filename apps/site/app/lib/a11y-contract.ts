...
export const a11yContract = {
  ...
  verification: {
    checks: [
      ...
      { id: 'a11', item: 'No internal naming on public surfaces (brand boundary)', pass: 'Clean', fail: 'Found' },
    ],
    ...
    validation_tools: {
      ...
      designesy_specific: 'a10, a11 require custom validator in internal adapter',
    },
  },
