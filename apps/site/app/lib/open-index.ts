...
export const openIndex = {
  ...
  packages: [
    ...
    },
    {
      ...
      version: '0.1',
      status: 'public',
      lede: 'Lab Two reviewed with Use Kit One · Design Review. Pass with notes. Live CSS confirms every verifiable rule. Five takt rules adopted into contract v0.1.2.',
    ...
    },
    {
      ...
      version: '0.1',
      status: 'public',
      lede: 'Lab Four reviewed with Use Kit One · Design Review. Pass with notes. Nineteen cues, nineteen roles, five accessibility protections. Acoustic mapping rules adopted into contract v0.3.0.',
      human_url: 'https://www.designesy.org/review/acoustics',
      machine_url: null,
    ...
    },
    {
      ...
      machine_path: '/contracts/tokens.json',
    },
    {
      id: 'designesy.a11y',
      kind: 'contract' as const,
      ...
      path: '/contracts/a11y',
      machine_path: '/contracts/a11y.json',
    },
    {
      id: 'designesy.motion',
      kind: 'contract' as const,
