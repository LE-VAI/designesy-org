...
export const openIndex = {
  ...
  packages: [
    {
      ...
      version: '0.1.2',
      status: 'public',
      lede: 'Portable design judgment for designesy.org — tokens, motion, components, and adopted Poise + Takt interaction rules.',
  ...
  machine_exports: [
    ...
    },
    {
      ...
      meta: 'v0.1.2 tokens, interaction, takt, verification',
    },
    {
