...
export const openIndex = {
  ...
  packages: [
    ...
    },
    {
      ...
      version: '0.1',
      status: 'live',
      lede: 'Interaction sound — ten cues, ten roles, Cuelume v0.1.0 engine. Acoustic token system adopted into contract v0.3.0.',
    ...
    },
    {
      ...
      version: '0.1',
      status: 'public',
      lede: 'Lab Four reviewed with Use Kit One · Design Review. Pass with notes. Ten cues, ten roles, five accessibility protections. Acoustic mapping rules adopted into contract v0.3.0.',
