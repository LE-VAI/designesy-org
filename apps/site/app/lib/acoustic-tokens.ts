...
export const acousticTokens = {
  ...
  tokens: [
    ...
    },
    {
      ...
      where_used:
        'Pillar cards, Lab field card hover, kit cards, open field cards, work cards, graph cards, docs cards, learn cards, review cards, continuity cards, score target landing',
    },
    {
      token: '--cue:list',
      cuelume_cue: 'whisper',
      ...
      where_used: 'Contracts pages, review overview, check grids, toggle rows, state-of-compliance, dense principle rails',
    },
    {
      token: '--cue:switch',
      cuelume_cue: 'toggle',
    ...
    // ── Extended cues (cuelume-extend.ts v0.2.0, 2026-08-08) ──────────
    {
      ...
      where_used: 'Score form network failure, copy failure, not-found page, error page',
    },
    {
      token: '--cue:warning',
      cuelume_cue: 'warning',
    ...
    },
    {
      ...
      where_used: 'Copy-to-clipboard success confirmation',
    },
    {
      token: '--cue:blocked',
      cuelume_cue: 'blocked',
      ...
      where_used: 'Score form rate limit / access denied (HTTP 403/429 analogues)',
    },
    {
      token: '--cue:retry',
      cuelume_cue: 'retry',
      ...
      where_used: 'Score form fetch failures (502, timeout, could not reach target)',
    },
    {
