...
<div class="footnote">
  Generated by <a href="${baseUrl}" target="_blank" rel="noopener">Designesy</a> · synthesis of /score (${ENGINE_CHECK_COUNT}-check), /drift (12-check), /readiness (10-check) ·
...
(function() {
  ...
  function render(result) {
    ...
    enginesEl.innerHTML =
      engineCard('Score', '×0.5', result.score, '${ENGINE_CHECK_COUNT}-check audit') +
