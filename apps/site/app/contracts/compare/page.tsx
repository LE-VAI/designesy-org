    ...
    <>
      ...
      <main id="main-content" className="surface-page" data-pagefind-meta="priority:high">
        ...
        <section className="doctrine-section fade-up">
          ...
          <div className="definition">
            <p className="definition-label">File-level diff</p>
            <p>{c.source_authority.file_level}</p>
          </div>
          <div className="definition">
            <p className="definition-label">Hosted diff</p>
            <p>{c.source_authority.hosted}</p>
          </div>
          <div className="definition">
            <p className="definition-label">Slug-level diff</p>
            <p>{c.source_authority.slug_level}</p>
          </div>
          <div className="definition">
