...
const IMPLEMENTATION_NOTES = [
  ...
  'metadataBase is https://designesy.org; public label is Designesy (never internal on renderable surfaces)',
...
const VERIFICATION = [
  ...
  'No public surface displays the internal control-plane name internal',
];
