...
function checkNoAtlasNaming(html: string): CheckResult {
  ...
  if (/internal/i.test(visibleHtml)) return { id: 'v07', item: 'No public surface displays internal control-plane naming', category: 'identity', status: 'FAIL', detail: 'found internal naming on public surface' };
