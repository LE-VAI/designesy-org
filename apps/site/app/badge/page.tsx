...
export const metadata: Metadata = pageMeta({
  title: 'Badge',
  description:
    `Sites that pass the ${ENGINE_CHECK_COUNT}-check Designesy design contract gate can embed the Verified by Designesy badge. The badge links to a live score anyone can verify.`,
  path: '/badge',
      ...
      <main id="main-content" data-pagefind-body className="surface-page">
        <section className="surface-header fade-up">
          ...
          <p className="surface-lede">
            Sites that pass the {ENGINE_CHECK_COUNT}-check design contract gate can embed the badge.
