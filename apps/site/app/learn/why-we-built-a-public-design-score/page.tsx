...
const REASONS = [
  ...
  },
  {
    ...
    desc: 'The 23-check engine that scores your site scores designesy.org. The same thresholds. The same letter grade. The same honest SKIPs when a browser path is not enabled. If we ever fail our own contract, the score says so on the same surface.',
  },
  {
    num: '03',
          ...
          <div className="row-stack" role="list">
            ...
            >
              ...
              <span className="row-body">
                ...
                <span className="row-meta">Run the 23-check engine against your own site</span>
              </span>
            </Link>
            <Link
