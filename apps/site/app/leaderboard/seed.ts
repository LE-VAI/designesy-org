...
const RAW_SEED: Omit<SeedSite, 'rank'>[] = [
  ...
  { url: 'https://www.designesy.org', name: 'Designesy', tier: 2, category: 'Design Systems', score: 95.3, grade: 'A', pass: 33, fail: 0, warn: 3, skip: 1, tokens: 50, seededBecause: 'Self-score — transparency earns trust. Conflict of interest: Designesy operates the scoring engine. Re-run live: /score?url=designesy.org', prevScore: 100, liveScoreUrl: '/score/report?url=designesy.org', coiDisclosure: 'Self-scored by the engine operator' },
  ...
  { url: 'https://internalsian.design', name: 'Atlassian Design System', tier: 3, category: 'Design Systems', score: 70.2, grade: 'C', pass: 14, fail: 3, warn: 19, skip: 1, tokens: 27, seededBecause: 'Motion + tokens exemplar', prevScore: 65.1 },
