...
const RAW_SEED: Omit<SeedSite, 'rank'>[] = [
  ...
  { url: 'https://vercel.com', name: 'Vercel', tier: 1, category: 'SaaS', score: 79.6, grade: 'C', pass: 21, fail: 3, warn: 6, skip: 9, tokens: 3, seededBecause: 'Frontier reference — Geist design system', prevScore: 76.5 },
  ...
  { url: 'https://apple.com', name: 'Apple', tier: 1, category: 'Hardware', score: 84.8, grade: 'B', pass: 16, fail: 2, warn: 11, skip: 10, tokens: 90, seededBecause: 'Apple HIG — tiered reduced-motion reference', prevScore: 77.1 },
  { url: 'https://nytimes.com', name: 'The New York Times', tier: 1, category: 'Editorial', score: 72.8, grade: 'C', pass: 13, fail: 2, warn: 10, skip: 14, tokens: 85, seededBecause: 'Editorial typography — Cadence rules origin', prevScore: 74.7 },
  ...
  { url: 'https://zeroheight.com', name: 'zeroheight', tier: 2, category: 'Design Systems', score: 70, grade: 'C', pass: 15, fail: 2, warn: 10, skip: 12, tokens: 134, seededBecause: 'DTCG 2025.10 incumbent', prevScore: 83.2 },
  ...
  { url: 'https://primer.style', name: 'GitHub Primer', tier: 3, category: 'Design Systems', score: 82.4, grade: 'B', pass: 26, fail: 3, warn: 3, skip: 7, tokens: 521, seededBecause: 'Contract-adjacent', prevScore: 82.4 },
  ...
  { url: 'https://awwwards.com', name: 'Awwwards', tier: 4, category: 'Inspiration', score: 71.6, grade: 'C', pass: 15, fail: 3, warn: 10, skip: 11, tokens: 98, seededBecause: 'Exemplar discovery surface', prevScore: 70.3 },
  ...
  { url: 'https://wikipedia.org', name: 'Wikipedia', tier: 5, category: 'Reference', score: 79, grade: 'C', pass: 15, fail: 2, warn: 9, skip: 13, tokens: 421, seededBecause: 'High-traffic reference — minimal-design baseline', prevScore: 77.3 },
];
...
export const LEADERBOARD_LAST_SCORED = '2026-09-14';
