...
const RAW_SEED: Omit<SeedSite, 'rank'>[] = [
  ...
  { url: 'https://www.designesy.org', name: 'Designesy', tier: 2, category: 'Design Systems', score: 100, grade: 'A', pass: 37, fail: 0, warn: 0, skip: 3, tokens: 50, seededBecause: 'Self-score — transparency earns trust', prevScore: 99.2 },
  ...
  { url: 'https://internalsian.design', name: 'Atlassian Design System', tier: 3, category: 'Design Systems', score: 65.1, grade: 'D', pass: 14, fail: 4, warn: 18, skip: 4, tokens: 27, seededBecause: 'Motion + tokens exemplar', prevScore: 61.9 },
