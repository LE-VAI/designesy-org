...
const RAW_SEED: Omit<SeedSite, 'rank'>[] = [
  ...
  { url: 'https://internalsian.design', name: 'Atlassian Design System', tier: 3, category: 'Design Systems', score: 84.3, grade: 'B', pass: 16, fail: 2, warn: 10, skip: 11, tokens: 27, seededBecause: 'Motion + tokens exemplar', prevScore: 79.3 },
  { url: 'https://primer.style', name: 'GitHub Primer', tier: 3, category: 'Design Systems', score: 82.4, grade: 'B', pass: 26, fail: 3, warn: 3, skip: 7, tokens: 518, seededBecause: 'Contract-adjacent', prevScore: 82.4 },
  ...
  { url: 'https://notion.so', name: 'Notion', tier: 5, category: 'SaaS', score: 66.1, grade: 'D', pass: 17, fail: 4, warn: 8, skip: 10, tokens: 544, seededBecause: 'Product surface — Linear/Stripe competitor', prevScore: 67.9 },
...
export const LEADERBOARD_LAST_SCORED = '2026-09-07';
