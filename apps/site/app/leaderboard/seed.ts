...
const RAW_SEED: Omit<SeedSite, 'rank'>[] = [
  { url: 'https://linear.app', name: 'Linear', tier: 1, category: 'SaaS', score: 69.5, grade: 'D', pass: 20, fail: 2, warn: 10, skip: 7, tokens: 191, seededBecause: 'Frontier reference — invariant-craft tier', prevScore: 67.7 },
  { url: 'https://vercel.com', name: 'Vercel', tier: 1, category: 'SaaS', score: 81.7, grade: 'B', pass: 22, fail: 2, warn: 6, skip: 9, tokens: 3, seededBecause: 'Frontier reference — Geist design system', prevScore: 76.5 },
  ...
  { url: 'https://apple.com', name: 'Apple', tier: 1, category: 'Hardware', score: 83.1, grade: 'B', pass: 15, fail: 2, warn: 12, skip: 10, tokens: 90, seededBecause: 'Apple HIG — tiered reduced-motion reference', prevScore: 77.1 },
  { url: 'https://nytimes.com', name: 'The New York Times', tier: 1, category: 'Editorial', score: 61.5, grade: 'D', pass: 6, fail: 2, warn: 10, skip: 21, tokens: 0, seededBecause: 'Editorial typography — Cadence rules origin', prevScore: 74.7 },
  ...
  { url: 'https://designesy.ai.studio', name: 'Designesy AI Studio', tier: 2, category: 'Design Systems', score: 74.8, grade: 'C', pass: 12, fail: 1, warn: 13, skip: 13, tokens: 28, seededBecause: 'AI Studio mirror — parity relationship', prevScore: 73.3 },
  { url: 'https://getdesy.com', name: 'Desy Guard', tier: 2, category: 'Design Systems', score: 61.5, grade: 'D', pass: 6, fail: 2, warn: 10, skip: 21, tokens: 0, seededBecause: 'AST-gate competitor', prevScore: 73.4 },
  ...
  { url: 'https://zeroheight.com', name: 'zeroheight', tier: 2, category: 'Design Systems', score: 70, grade: 'C', pass: 15, fail: 1, warn: 11, skip: 12, tokens: 134, seededBecause: 'DTCG 2025.10 incumbent', prevScore: 83.2 },
  { url: 'https://roastbyai.com', name: 'Roast by AI', tier: 2, category: 'Design Systems', score: 71.2, grade: 'C', pass: 18, fail: 1, warn: 8, skip: 12, tokens: 46, seededBecause: 'Roast competitor — leaderboard model reference', prevScore: 70 },
  { url: 'https://atlassian.design', name: 'Atlassian Design System', tier: 3, category: 'Design Systems', score: 86.1, grade: 'B', pass: 17, fail: 2, warn: 9, skip: 11, tokens: 28, seededBecause: 'Motion + tokens exemplar', prevScore: 79.3 },
  { url: 'https://primer.style', name: 'GitHub Primer', tier: 3, category: 'Design Systems', score: 82.4, grade: 'B', pass: 25, fail: 2, warn: 5, skip: 7, tokens: 521, seededBecause: 'Contract-adjacent', prevScore: 82.4 },
  ...
  { url: 'https://radix-ui.com', name: 'Radix Colors', tier: 3, category: 'Design Systems', score: 63.2, grade: 'D', pass: 14, fail: 3, warn: 12, skip: 10, tokens: 59, seededBecause: '12-step semantic color', prevScore: 64.8 },
  ...
  { url: 'https://fwa.org', name: 'FWA', tier: 4, category: 'Inspiration', score: 48, grade: 'F', pass: 8, fail: 3, warn: 13, skip: 15, tokens: 44, seededBecause: 'Creative exemplars', prevScore: 43.8 },
  { url: 'https://cssdesignawards.com', name: 'CSS Design Awards', tier: 4, category: 'Inspiration', score: 61.5, grade: 'D', pass: 6, fail: 2, warn: 10, skip: 21, tokens: 0, seededBecause: 'Design awards', prevScore: 44.9 },
  { url: 'https://pentagram.com', name: 'Pentagram', tier: 4, category: 'Agency', score: 48.3, grade: 'F', pass: 10, fail: 3, warn: 12, skip: 14, tokens: 181, seededBecause: 'Parent-system posture analog', prevScore: 50 },
  ...
  { url: 'https://github.com', name: 'GitHub', tier: 5, category: 'SaaS', score: 68.5, grade: 'D', pass: 23, fail: 3, warn: 6, skip: 7, tokens: 576, seededBecause: 'High-traffic dev surface — Primer in production', prevScore: 69.3 },
  { url: 'https://notion.so', name: 'Notion', tier: 5, category: 'SaaS', score: 65, grade: 'D', pass: 16, fail: 4, warn: 9, skip: 10, tokens: 544, seededBecause: 'Product surface — Linear/Stripe competitor', prevScore: 67.9 },
  { url: 'https://figma.com', name: 'Figma', tier: 5, category: 'SaaS', score: 76.6, grade: 'C', pass: 18, fail: 1, warn: 9, skip: 11, tokens: 102, seededBecause: 'Design tool surface — token workflow origin', prevScore: 75.3 },
  { url: 'https://x.com', name: 'X', tier: 5, category: 'Consumer', score: 77.8, grade: 'C', pass: 17, fail: 0, warn: 10, skip: 12, tokens: 166, seededBecause: 'High-traffic consumer surface — a11y calibration', prevScore: 82.8 },
  { url: 'https://wikipedia.org', name: 'Wikipedia', tier: 5, category: 'Reference', score: 80.7, grade: 'B', pass: 16, fail: 2, warn: 8, skip: 13, tokens: 421, seededBecause: 'High-traffic reference — minimal-design baseline', prevScore: 77.3 },
];
...
export const LEADERBOARD_LAST_SCORED = '2026-09-18';
