...
const RAW_SEED: Omit<SeedSite, 'rank'>[] = [
  ...
  { url: 'https://www.designesy.org', name: 'Designesy', tier: 2, category: 'Design Systems', score: 95.2, grade: 'A', pass: 20, fail: 1, warn: 0, skip: 5, tokens: 39, seededBecause: 'Self-score — transparency earns trust' },
  ...
  { url: 'https://internalsian.design', name: 'Atlassian Design System', tier: 3, category: 'Design Systems', score: 45.0, grade: 'F', pass: 8, fail: 10, warn: 2, skip: 6, tokens: 32, seededBecause: 'Motion + tokens exemplar' },
...
export const LEADERBOARD_LAST_SCORED = '2026-07-26';
