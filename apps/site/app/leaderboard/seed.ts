...
const RAW_SEED: Omit<SeedSite, 'rank'>[] = [
  { url: 'https://linear.app', name: 'Linear', tier: 1, category: 'SaaS', score: 67.7, grade: 'D', pass: 19, fail: 3, warn: 10, skip: 7, tokens: 191, seededBecause: 'Frontier reference — invariant-craft tier', prevScore: 70 },
  ...
  { url: 'https://stripe.com', name: 'Stripe', tier: 1, category: 'SaaS', score: 66.9, grade: 'D', pass: 18, fail: 1, warn: 11, skip: 9, tokens: 714, seededBecause: 'Frontier reference — mature design system', prevScore: 70 },
  { url: 'https://apple.com', name: 'Apple', tier: 1, category: 'Hardware', score: 77.1, grade: 'C', pass: 15, fail: 2, warn: 12, skip: 10, tokens: 90, seededBecause: 'Apple HIG — tiered reduced-motion reference', prevScore: 80.4 },
  { url: 'https://nytimes.com', name: 'The New York Times', tier: 1, category: 'Editorial', score: 74.7, grade: 'C', pass: 11, fail: 2, warn: 10, skip: 16, tokens: 85, seededBecause: 'Editorial typography — Cadence rules origin', prevScore: 74.7 },
  ...
  { url: 'https://designesy.ai.studio', name: 'Designesy AI Studio', tier: 2, category: 'Design Systems', score: 73.3, grade: 'C', pass: 11, fail: 1, warn: 14, skip: 13, tokens: 28, seededBecause: 'AI Studio mirror — parity relationship', prevScore: 72.6 },
  { url: 'https://getdesy.com', name: 'Desy Guard', tier: 2, category: 'Design Systems', score: 73.4, grade: 'C', pass: 19, fail: 1, warn: 8, skip: 11, tokens: 61, seededBecause: 'AST-gate competitor', prevScore: 77.8 },
  ...
  { url: 'https://zeroheight.com', name: 'zeroheight', tier: 2, category: 'Design Systems', score: 83.2, grade: 'B', pass: 16, fail: 2, warn: 9, skip: 12, tokens: 134, seededBecause: 'DTCG 2025.10 incumbent', prevScore: 87.2 },
  { url: 'https://roastbyai.com', name: 'Roast by AI', tier: 2, category: 'Design Systems', score: 70, grade: 'C', pass: 17, fail: 1, warn: 9, skip: 12, tokens: 46, seededBecause: 'Roast competitor — leaderboard model reference', prevScore: 70.6 },
  { url: 'https://internalsian.design', name: 'Atlassian Design System', tier: 3, category: 'Design Systems', score: 79.3, grade: 'C', pass: 16, fail: 2, warn: 10, skip: 11, tokens: 27, seededBecause: 'Motion + tokens exemplar', prevScore: 79.4 },
  { url: 'https://primer.style', name: 'GitHub Primer', tier: 3, category: 'Design Systems', score: 82.4, grade: 'B', pass: 26, fail: 3, warn: 3, skip: 7, tokens: 517, seededBecause: 'Contract-adjacent', prevScore: 86.4 },
  ...
  { url: 'https://m3.material.io', name: 'Material 3', tier: 3, category: 'Design Systems', score: 67.6, grade: 'D', pass: 7, fail: 2, warn: 12, skip: 18, tokens: 158, seededBecause: 'MotionScheme + Sound — closest to designesy combo', prevScore: 66.1 },
  { url: 'https://radix-ui.com', name: 'Radix Colors', tier: 3, category: 'Design Systems', score: 64.8, grade: 'D', pass: 15, fail: 3, warn: 11, skip: 10, tokens: 59, seededBecause: '12-step semantic color', prevScore: 67.7 },
  ...
  { url: 'https://awwwards.com', name: 'Awwwards', tier: 4, category: 'Inspiration', score: 70.3, grade: 'C', pass: 14, fail: 3, warn: 11, skip: 11, tokens: 98, seededBecause: 'Exemplar discovery surface', prevScore: 69.3 },
  { url: 'https://fwa.org', name: 'FWA', tier: 4, category: 'Inspiration', score: 43.8, grade: 'F', pass: 7, fail: 3, warn: 13, skip: 16, tokens: 8, seededBecause: 'Creative exemplars', prevScore: 44.8 },
  ...
  { url: 'https://pentagram.com', name: 'Pentagram', tier: 4, category: 'Agency', score: 50, grade: 'F', pass: 11, fail: 3, warn: 11, skip: 14, tokens: 181, seededBecause: 'Parent-system posture analog', prevScore: 52.3 },
  ...
  { url: 'https://github.com', name: 'GitHub', tier: 5, category: 'SaaS', score: 69.3, grade: 'D', pass: 24, fail: 3, warn: 5, skip: 7, tokens: 575, seededBecause: 'High-traffic dev surface — Primer in production', prevScore: 73.4 },
  { url: 'https://notion.so', name: 'Notion', tier: 5, category: 'SaaS', score: 67.9, grade: 'D', pass: 18, fail: 4, warn: 7, skip: 10, tokens: 544, seededBecause: 'Product surface — Linear/Stripe competitor', prevScore: 71.1 },
  { url: 'https://figma.com', name: 'Figma', tier: 5, category: 'SaaS', score: 75.3, grade: 'C', pass: 18, fail: 2, warn: 8, skip: 11, tokens: 102, seededBecause: 'Design tool surface — token workflow origin', prevScore: 76 },
  { url: 'https://x.com', name: 'X', tier: 5, category: 'Consumer', score: 82.8, grade: 'B', pass: 17, fail: 0, warn: 10, skip: 12, tokens: 166, seededBecause: 'High-traffic consumer surface — a11y calibration', prevScore: 87.3 },
  { url: 'https://wikipedia.org', name: 'Wikipedia', tier: 5, category: 'Reference', score: 77.3, grade: 'C', pass: 15, fail: 3, warn: 8, skip: 13, tokens: 393, seededBecause: 'High-traffic reference — minimal-design baseline', prevScore: 73.9 },
];
