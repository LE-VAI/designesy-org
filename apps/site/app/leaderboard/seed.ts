...
const RAW_SEED: Omit<SeedSite, 'rank'>[] = [
  ...
  { url: 'https://internalsian.design', name: 'Atlassian Design System', tier: 3, category: 'Design Systems', score: 62.0, grade: 'D', pass: 10, fail: 4, warn: 16, skip: 4, tokens: 32, seededBecause: 'Motion + tokens exemplar' },
