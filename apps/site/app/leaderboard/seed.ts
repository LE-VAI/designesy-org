...
const RAW_SEED: Omit<SeedSite, 'rank'>[] = [
  ...
  { url: 'https://atlassian.design', name: 'Atlassian Design System', tier: 3, category: 'Design Systems', score: 84.3, grade: 'B', pass: 16, fail: 2, warn: 10, skip: 11, tokens: 27, seededBecause: 'Motion + tokens exemplar', prevScore: 79.3 },
