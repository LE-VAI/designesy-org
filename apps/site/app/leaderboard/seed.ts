...
const RAW_SEED: Omit<SeedSite, 'rank'>[] = [
  ...
  { url: 'https://www.designesy.org', name: 'Designesy', tier: 2, category: 'Design Systems', score: 100, grade: 'A', pass: 35, fail: 0, warn: 1, skip: 4, tokens: 50, seededBecause: 'Self-score — transparency earns trust', prevScore: 99.2 },
