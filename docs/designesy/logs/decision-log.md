...
|---|---|---|---|---|
| 2026-05-03 | Keep `D:\DESIGNESY` private/internal and `D:\DESIGNESY_PUBLIC/designesy-org` as the controlled public root. | Separates internal build surface from public governance surface while preserving controlled publication. | `docs/designesy/00-context-map.md` | active |
